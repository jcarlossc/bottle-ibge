...
def index():
    ...
    try:
        ...
        plotar_grafico(df1[0], df1[1], "Chegada de Turistas", "Ano", "Milhões", "grafico_turismo.png")
        ...
        plotar_grafico(df2[0], df2[1], "Gastos públicos com Educação - IBGE", "Ano", "% do PIB", "grafico_educacao.png")
        ...
        plotar_grafico(df2[0], df2[1], "Gastos públicos com Educação - IBGE", "Ano", "% do PIB", "grafico_saude.png")
        imagens.append("/static/data/grafico_saude.png")
        
        # Gráfico 3: Gastos públicos com pesquisa e desenvolvimento
